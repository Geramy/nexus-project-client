...
class AgentPersonas extends Table {
  ...
  RealColumn get costPerMillionTokens =>
  ...
  TextColumn get configJson => text().withDefault(
    const Constant('{}'),
  )(); // permissions, approval gates, etc.
  ...
  IntColumn get provider_fk =>
      integer().nullable().references(InferenceServers, #server_pk)();
  ...
  TextColumn get visionModel =>
      text().nullable()(); // Image reading / understanding
  TextColumn get llmModel =>
      text().nullable()(); // Text generation (primary LLM)
