...
Color colorForNodeType(CallNodeType t, ColorScheme scheme) => switch (t) {
  ...
  CallNodeType.playDirectory => const Color(0xFF2F6FED),
  CallNodeType.menu ||
  CallNodeType.gatherDigits ||
  CallNodeType.gatherSpeech ||
  CallNodeType.record => const Color(0xFF1AA0A0),
  ...
  CallNodeType.subFlow => const Color(0xFF7A5AF8),
  CallNodeType.schedule ||
  CallNodeType.condition ||
  CallNodeType.setVariable ||
  CallNodeType.httpRequest => const Color(0xFFD9920B),
