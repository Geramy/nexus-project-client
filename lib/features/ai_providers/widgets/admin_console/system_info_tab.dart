...
/// Ported from ~/IdeaProjects/lemonade_mobile/lib/widgets/admin/admin_system_info_tab.dart
...
/// System info tab showing hardware details and device enumeration.
        ...
        children: [
          _Card(
            ...
            entries: {
              ...
              'BIOS': info['BIOS Version']?.toString() ?? '—',
              'Power': info['Windows Power Setting']?.toString() ?? '—',
            },
          ),
