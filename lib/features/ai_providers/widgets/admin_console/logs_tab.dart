...
/// Ported from ~/IdeaProjects/lemonade_mobile/lib/widgets/admin/admin_logs_tab.dart
...
import 'logs_socket.dart';

/// Logs tab with WebSocket live log stream, filtering, and pause/resume.
  ...
  Iterable<LogEntry> _visible() {
    return _entries.where((e) {
      if (_severityFilter != 'All' &&
          e.severity.toLowerCase() != _severityFilter.toLowerCase()) {
        return false;
      }
      if (_filter.isNotEmpty &&
          !e.line.toLowerCase().contains(_filter.toLowerCase())) {
        return false;
      }
      return true;
    });
