...
/// Ported from ~/IdeaProjects/lemonade_mobile/lib/widgets/admin/admin_backends_tab.dart
...
/// Backends tab showing recipe/backend install/uninstall management.
...
class _RecipeCard extends StatelessWidget {
  ...
  final Future<void> Function(String, String, {bool force}) onInstall;
      ...
      child: Row(
        children: [
          ...
          if (state == 'installed')
            ...
            TextButton(
              onPressed: () => onInstall(recipe, backend, force: true),
